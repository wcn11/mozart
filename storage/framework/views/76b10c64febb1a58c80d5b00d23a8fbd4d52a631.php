...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
            <form class="form form-upload" action="<?php echo e(route('mentor.materi_upload_aksi')); ?>" class="col-md-12" method="POST" enctype="multipart/form-data">
                ...
                <?php echo csrf_field(); ?>
                <input type="hidden" name="kmp" value="<?php echo e($kmp); ?>">
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <p> <?php echo e($mapel->nama_pelajaran); ?> </p>
                                        <input type="hidden" name="kode_mapel" value="<?php echo e($kode_mapel); ?>">
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <div class="input-group-prepend">
...
<?php echo $__env->make('mentor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mozzart/Documents/TUGAS AKHIR/mozart-elearning/resources/views/mentor/pages/materi/materi_upload.blade.php ENDPATH**/ ?>