                ...
                <div class="row"> 
                    <div class="col-md-6 grid-margin"> 
                        <div class="form-group "> 
                            ...
                            <input type="text" value="<?php echo e($soal[$i]['pertanyaan']); ?>" required="required" name="pertanyaan[]" class="form-control" id="pertanyaan-i" aria-describedby="textHelp" placeholder="Enter text"> 
                        </div> 
                        <div class="form-group"> 
...
<?php echo $__env->make('mentor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mozzart/Documents/TUGAS AKHIR/mozart-elearning/resources/views/mentor/pages/question/question_edit.blade.php ENDPATH**/ ?>