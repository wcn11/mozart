                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $m_value->mp_ke_materi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="text-center">
                                                ...
                                                <td><button class="btn btn-info btn-lihat" data-id="<?php echo e($m2->kode_materi); ?>"><i class="fas fa-eye"></i> Lihat materi</button></td>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mentor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mozzart/Documents/TUGAS AKHIR/mozart-elearning/resources/views/mentor/pages/materi/daftar_materi.blade.php ENDPATH**/ ?>