                        ...
                        <?php $__currentLoopData = $mapel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="tab-pane fade" id="nav-<?php echo e($mpl->kode_mapel); ?>" role="tabpanel" aria-labelledby="nav-<?php echo e($mpl->kode_mapel); ?>-tab">
                                ...
                                <div class="container p-3 text-center">
                                    ...
                                    <button href="#" data-id="<?php echo e($mpl->kode_mapel); ?>" data-nama="<?php echo e($mpl->nama_pelajaran); ?>" data-kuota="<?php echo e($mpl->kuota); ?>" data-js="<?php echo e(count($mpl->pelajaran_student)); ?>" class="btn btn-outline-secondary btn-edit-kuota animated bounceInUp"><i class="fas fa-edit"></i> Edit kuota</button>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mentor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mozzart/Documents/TUGAS AKHIR/mozart-elearning/resources/views/mentor/pages/pelajaran.blade.php ENDPATH**/ ?>