                    ...
                    <div class="row">
                        <div class="col-md-6 grid-margin">
                            <div class="form-group ">
                                ...
                                <label for="pertanyaan">Pertanyaan ke <?php echo e($i + 1); ?><span class="text-danger control-label">*</span></label>
                                <input type="text" required="required" name="pertanyaan" data-id="<?php echo e($soal[$i]['kode_soal']); ?>" class="form-control pertanyaan" id="pertanyaan-<?php echo e($i); ?>-<?php echo e($soal[$i]['kode_soal']); ?>" aria-describedby="textHelp" placeholder="Enter text">
...
<?php echo $__env->make('mentor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mozzart/Documents/TUGAS AKHIR/mozart-elearning/resources/views/mentor/pages/question/question_create.blade.php ENDPATH**/ ?>